"""
topic01_contracts_validation_intermediate
...
if __name__ == "__main__":
    ...
    run_topic_demo(
        topic_id="topic01_contracts_validation_intermediate",
        topic_name="Contracts Validation",
        complexity="intermediate",
        method_focus="contracts_validation",
    )
