...
Stage metadata:
- Stage: `stage-13`
- Recommended output root: `results/stage13/`
...
|---|---|---|---|
| `pain_point_matrix.md` | `results/lab2_solution_options.csv` | `mapped` | Auto-mapped from existing stage output (2026-04-04). |
| `before_after_metrics.csv` | `results/lab2_before_after_delta.csv` | `mapped` | Auto-mapped from existing stage output (2026-04-04). |
| `verification_report.md` | `results/lab3_verification_rerun.csv` | `mapped` | Auto-mapped from existing stage output (2026-04-04). |
