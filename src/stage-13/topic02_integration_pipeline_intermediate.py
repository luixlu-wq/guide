"""
topic02_integration_pipeline_intermediate
...
if __name__ == "__main__":
    ...
    run_topic_demo(
        topic_id="topic02_integration_pipeline_intermediate",
        topic_name="Integration Pipeline",
        complexity="intermediate",
        method_focus="integration_pipeline",
    )
