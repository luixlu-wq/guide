"""
topic04_multi_agent_pattern_intermediate
...
if __name__ == "__main__":
    run_topic_demo(
        topic_id="topic04_multi_agent_pattern_intermediate",
        topic_name="Multi-Agent Pattern",
        complexity="intermediate",
        method_focus="multi_agent_pattern",
    )
