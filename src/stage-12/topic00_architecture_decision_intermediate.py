"""
topic00_architecture_decision_intermediate
...
if __name__ == "__main__":
    run_topic_demo(
        topic_id="topic00_architecture_decision_intermediate",
        topic_name="Architecture Decision",
        complexity="intermediate",
        method_focus="architecture_decision",
    )
