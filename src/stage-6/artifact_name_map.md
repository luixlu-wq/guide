...
Stage metadata:
- Stage: `stage-6`
- Recommended output root: `results/stage6/`
...
| `before_after_metrics.csv` | `results/lab2_comparison_before_after.csv` | `mapped` | Auto-mapped from existing stage output (2026-04-04). |
| `verification_report.md` | `results/lab3_incident_postmortem.md` | `mapped` | Auto-mapped from existing stage output (2026-04-04). |
| `decision_log.md` | `results/lab3_policy_decisions.csv` | `mapped` | Auto-mapped from existing stage output (2026-04-04). |
