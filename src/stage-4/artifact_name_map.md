...
Stage metadata:
- Stage: `stage-4`
- Recommended output root: `results/stage4/`
...
|---|---|---|---|
| `pain_point_matrix.md` | `results/pain_point_matrix.md` | `mapped` | Alias placeholder created automatically on 2026-04-04; replace TODO content with stage-specific evidence. |
| `before_after_metrics.csv` | `results/metrics_before.csv + results/metrics_after.csv` | `mapped` | Auto-mapped from existing stage output (2026-04-04). |
| `verification_report.md` | `results/verification_report.md` | `mapped` | Alias placeholder created automatically on 2026-04-04; replace TODO content with stage-specific evidence. |
| `decision_log.md` | `results/final_choice.md` | `mapped` | Auto-mapped from existing stage output (2026-04-04). |
