...
Stage metadata:
- Stage: `stage-14`
- Recommended output root: `results/stage14/`
...
| `before_after_metrics.csv` | `results/lab2_risk_before_after.csv` | `mapped` | Auto-mapped from existing stage output (2026-04-04). |
