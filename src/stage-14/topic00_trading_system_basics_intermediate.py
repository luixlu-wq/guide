"""
topic00_trading_system_basics_intermediate
...
if __name__ == "__main__":
    ...
    run_topic_demo(
        topic_id="topic00_trading_system_basics_intermediate",
        topic_name="Trading System Basics",
        complexity="intermediate",
        method_focus="trading_system_basics",
    )
