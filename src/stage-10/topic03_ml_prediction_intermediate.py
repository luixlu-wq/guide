"""
topic03_ml_prediction_intermediate
...
if __name__ == "__main__":
    run_topic_demo(
        topic_id="topic03_ml_prediction_intermediate",
        topic_name="ML Prediction",
        complexity="intermediate",
        method_focus="ml_prediction",
    )
    # Extra PyTorch/CUDA component benchmark for ML topics.
    run_pytorch_cuda_component(
        topic_id="topic03_ml_prediction_intermediate",
        complexity="intermediate",
    )
