"""
topic07_evaluation_regression_intermediate
...
if __name__ == "__main__":
    run_topic_demo(
        topic_id="topic07_evaluation_regression_intermediate",
        topic_name="Evaluation and Regression Gates",
        complexity="intermediate",
        method_focus="evaluation_regression",
    )
