...
Stage metadata:
- Stage: `stage-9`
- Recommended output root: `results/stage9/`
...
|---|---|---|---|
| `pain_point_matrix.md` | `results/topic08a_decision_matrix_simple_metrics.csv` | `mapped` | Auto-mapped from existing stage output (2026-04-04). |
| `before_after_metrics.csv` | `results/lab5_metrics_comparison.csv` | `mapped` | Auto-mapped from existing stage output (2026-04-04). |
| `verification_report.md` | `results/lab4_verification_rerun.csv` | `mapped` | Auto-mapped from existing stage output (2026-04-04). |
| `decision_log.md` | `results/lab5_rollback_plan.md` | `mapped` | Auto-mapped from existing stage output (2026-04-04). |
