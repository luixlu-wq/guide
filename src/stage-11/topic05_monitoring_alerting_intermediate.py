"""
topic05_monitoring_alerting_intermediate
...
if __name__ == "__main__":
    run_topic_demo(
        topic_id="topic05_monitoring_alerting_intermediate",
        topic_name="Monitoring and Alerting",
        complexity="intermediate",
        method_focus="monitoring_alerting",
    )
