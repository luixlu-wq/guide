...
Stage metadata:
- Stage: `stage-15`
- Recommended output root: `results/stage15/`
...
| `verification_report.md` | `results/lab1_ml_verification_rerun.csv` | `mapped` | Auto-mapped from existing stage output (2026-04-04). |
| `decision_log.md` | `results/lab4_decision_record.md` | `mapped` | Auto-mapped from existing stage output (2026-04-04). |
