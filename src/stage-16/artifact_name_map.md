...
Stage metadata:
- Stage: `stage-16`
- Recommended output root: `results/stage16/`
...
| `verification_report.md` | `results/lab2_postmortem.md` | `mapped` | Auto-mapped from existing stage output (2026-04-04). |
| `decision_log.md` | `results/lab1_decision_record.md` | `mapped` | Auto-mapped from existing stage output (2026-04-04). |
