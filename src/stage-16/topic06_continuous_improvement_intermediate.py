"""
topic06_continuous_improvement_intermediate
...
if __name__ == "__main__":
    ...
    run_topic_demo(
        topic_id="topic06_continuous_improvement_intermediate",
        topic_name="Continuous Improvement",
        complexity="intermediate",
        method_focus="continuous_improvement",
    )
